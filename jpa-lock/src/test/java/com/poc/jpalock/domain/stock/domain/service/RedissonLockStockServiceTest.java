...
class RedissonLockStockServiceTest {
    ...
    class decrease_메소드는 {
        ...
        @Test
        void decreaseWithDistributedLock_메서드는_재고_감소가_잘_진행된다() throws InterruptedException {
            ...
            for (int i = 0; i < threadCounts; i++) {
                executorService.submit(() -> {
                    try {
                        redissonLockStockService.decreaseWithDistributedLock(new StockCommand(1L, 1L, 1L));
                    } finally {
